...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    if (joinUsSection) {
        try {
            ...
            // Si c'est un client ou non connecté, on garde le bandeau "Join Us" par défaut
            else {
                joinUsSection.innerHTML = `
                    <h2 class="section-title">Rejoignez-nous</h2>
                    <div class="rejoindre-text">
                        <p>Rejoignez-nous pour découvrir les créations des artisans et les acheter.</p>
                    </div>
                    <a href="connexion.html" class="join-button">Connexion</a>
                `;
            }
        } catch (error) {
